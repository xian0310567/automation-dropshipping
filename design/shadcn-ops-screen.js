...
const screens = {
  ...
  integrations: {
    ...
    title: "공급사·마켓 상태",
    desc: "오너클랜, 쿠팡, 알림 채널의 연결 상태와 최근 동기화 결과를 확인합니다.",
    cta: "연동 확인",
    cards: [["쿠팡 마켓", "정상 · 3분 전", "teal"], ["오너클랜", "주의 · 일부 지연", "amber"], ["알림 채널", "정상 · 즉시 발송", "teal"]],
    rows: [["오너클랜 재고", "상품 1,284개", "8개 상품 재고 부족 응답", "품절 위험 화면에 반영", "주의", "5분 전", "상품 보기", "amber"], ["쿠팡 주문", "신규 주문 12건", "주문 수집 정상 완료", "발주 대기 큐 업데이트", "정상", "3분 전", "주문 보기", "teal"]],
  },
  products: {
    active: "products",
    eyebrow: "운영 관리 · 상품",
